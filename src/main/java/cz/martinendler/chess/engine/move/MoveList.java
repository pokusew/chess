...
public class MoveList extends LinkedList<Move> {
	...
	//
	// private static EnumMap<Piece, String> sanNotation = new EnumMap<>(Piece.class);
	//
	// private static EnumMap<Piece, String> fanNotation = new EnumMap<>(Piece.class);
	//
	// private static Map<String, PieceType> sanNotationR = new HashMap<>(7);
	//
	// static {
